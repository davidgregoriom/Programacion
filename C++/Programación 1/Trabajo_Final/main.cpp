...
saldo_banca = saldo_inicial_total - saldo_final_jugadores;
...
//apostar:
    ...
    if (hay_que_continuar == 1){
     saldo_final_banca = saldo_final_banca +   funcion_saldo_banca (jugadores,numero_jugadores * saldo_inicial ) ;
     cout << "La banca tiene :" << saldo_final_banca;
    }
    else{
       saldo_final_banca =  saldo_final_banca + funcion_saldo_banca (jugadores,numero_jugadores * saldo_inicial ) ;
